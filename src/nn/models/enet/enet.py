...
class RegularBottleneck(nn.Module):
    ...
    def __init__(self, channels, internal_ratio=4, kernel_size=3,
                 padding=0, dilation=1, asymmetric=False,
...
class ENet(nn.Module):
    ...
    Pretrained weights: https://github.com/davidtvs/PyTorch-ENet/tree/master/save
    """
